...
# var=string.text
# # print(var)
# my_files=open("courses.json",'w')
# json.dump(url, my_files, indent = 6)
# print(my_files)
...
def cource(first_api):
    ...
    my_files=open("courses.json",'w') 
    data_write=my_files.write(string)
    store_data=json.dumps(string)
    print(store_data)

# # ***putting all saral data into json format in courses file by using loads***
